...
function error() {
    ...
    console.error.apply(console, __spreadArray([(_a = getStyledTextForLogging('red')) === null || _a === void 0 ? void 0 : _a('error')], messages));
}
exports.error = error;
function log(style, title) {
    ...
    console.info.apply(console, __spreadArray([require('cli-color').whiteBright.bgCyan('debug'), (_a = getStyledTextForLogging(style)) === null || _a === void 0 ? void 0 : _a(title)], messages));
    if (lastMessage) {
...
function pathTransform(outputPath, inputPath, filePath) {
    ...
    return path_1.join.apply(void 0, __spreadArray([path_1.normalize(outputPath)], filePathRel));
}
